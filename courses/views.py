...
class WelcomePage(CourseListView):
    template_name = 'courses/course/welcome.html'


class CourseView(CourseListView):
    template_name = 'courses/course/courses.html'
...
class OwnerCourseMixin(OwnerMixin, LoginRequiredMixin, PermissionRequiredMixin):
    model = Course
    fields = ['subject', 'title', 'slug', 'overview', 'difficulty', 'pc', 'logo']
